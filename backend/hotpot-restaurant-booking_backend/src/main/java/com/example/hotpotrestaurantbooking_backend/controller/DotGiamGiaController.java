...
public class DotGiamGiaController {
    ...
    public List<DotGiamGiaResponse> phanTrangDGG(@RequestParam(defaultValue = "0") Integer pageNo,
                                                 @RequestParam(defaultValue = "5") Integer pageSize){
        return sv.phanTrangDGG(pageNo,pageSize).getContent();
    }
    @GetMapping("timKiemDGG")
    public List<DotGiamGiaResponse> timKiemDGG(
            ...
            @RequestParam(defaultValue = "5") Integer pageSize){
        return sv.timKiemDGG(tenChuongTrinh, tuNgay, denNgay, pageNo,pageSize).getContent();
    }
    @PostMapping("addDGG")
